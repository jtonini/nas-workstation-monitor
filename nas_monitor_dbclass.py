...
class NASMonitorDB(SQLiteDB):
    ...
    @trap
    def get_current_status(self) -> object:
        """
    ...
    @trap
    def get_unresolved_failures(self) -> object:
        """
    ...
    @trap
    def get_reliability(self) -> object:
        """
    ...
    @trap
    def get_software_summary(self) -> object:
        """
    ...
    @trap
    def get_workstation_detail(self, workstation: str, hours: int = 24) -> object:
        """
    ...
    @trap
    def get_mount_history(self, workstation: str, mount_point: str, hours: int = 168) -> object:
        """
